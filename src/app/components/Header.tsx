...
import { Menu, X, Phone, LogIn, Sparkles } from "lucide-react"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          {/* Boutons d'action très à droite - Ordre: Ask Quote | Language | Login */}
          <div className="hidden lg:flex items-center gap-0 ml-auto">
            ...
            >
              ...
              <Phone size={15} strokeWidth={2.5} className="relative z-10" />
            ...
            {/* Language Switcher - Drapeau uniquement */}
            <LanguageSwitcher />
          ...
          <motion.button
            whileTap={{ scale: 0.9 }}
            className="lg:hidden p-2.5 text-zinc-900 dark:text-white bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-700 rounded-xl shadow-md hover:shadow-lg transition-all"
          ...
          {/* Logo mobile - visible sur mobile seulement */}
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
          >
            <div className="relative h-10 w-10 rounded-xl overflow-hidden border-2 border-zinc-200/80 dark:border-zinc-700/80 shadow-lg transition-all duration-300 group-hover:shadow-xl">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="lg:hidden absolute left-4 right-4 mt-4 bg-white dark:bg-zinc-900 border-2 border-zinc-200/60 dark:border-zinc-800/60 rounded-3xl p-5 shadow-2xl"
            >
              <div className="flex flex-col gap-2">
                {menuItems.map((item, index) => (
                  <motion.button
                    ...
                    className={`w-full text-left px-5 py-4 rounded-2xl text-sm font-medium transition-all ${activeSection === item.id
                ...
                <div className="h-px bg-gradient-to-r from-transparent via-zinc-300 dark:via-zinc-700 to-transparent my-3" />
                ...
                <div className="px-1 py-2 flex flex-col gap-3">
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 bg-[#D4A574] hover:bg-[#C4965F] text-[#4B3935] shadow-lg hover:shadow-xl transition-all"
                  >
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-zinc-900 to-zinc-800 dark:from-white dark:to-zinc-100 text-white dark:text-zinc-900 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
                  >
                    <LogIn size={18} />
